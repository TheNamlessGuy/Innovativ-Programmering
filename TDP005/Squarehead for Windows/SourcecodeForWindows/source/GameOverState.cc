...
void GameOverState::create_highscore_text(SDL_Renderer* r)
{
	...
	{
		highscore.push_back(new Text(300, 0 + (50*i), my::to_string(i + 1) + ". " + highscore_values.at(i).second, r, font));
		highscore.push_back(new Text(400, 0 + (50*i), my::to_string(highscore_values.at(i).first), r, font));
	}

	highscore.push_back(new Text(275, 275, "Your   score   is:   " + my::to_string(private_score), r, font));
}

...
{
	Image* temp = new Image(0, 0, "src/images/powerups/armor.png", r);
	temp->get_hitbox().w -= 15;
	temp->get_hitbox().h -= 15;
	powerup_images.push_back(temp);
	temp = nullptr;

	temp = new Image(0, 0, "src/images/powerups/rapid.png", r);
	temp->get_hitbox().w -= 15;
	temp->get_hitbox().h -= 15;
	powerup_images.push_back(temp);
	temp = nullptr;

	temp = new Image(0, 0, "src/images/powerups/slow.png", r);
	temp->get_hitbox().w -= 15;
	temp->get_hitbox().h -= 15;
	powerup_images.push_back(temp);
	temp = nullptr;

	temp = new Image(0, 0, "src/images/powerups/penetrating.png", r);
	temp->get_hitbox().w -= 15;
	temp->get_hitbox().h -= 15;
	powerup_images.push_back(temp);
	temp = nullptr;

	temp = new Image(0, 0, "src/images/powerups/fast.png", r);
	temp->get_hitbox().w -= 15;
	temp->get_hitbox().h -= 15;
	powerup_images.push_back(temp);
	temp = nullptr;

	temp = new Image(0, 0, "src/images/powerups/slowfire.png", r);
	temp->get_hitbox().w -= 15;
	temp->get_hitbox().h -= 15;
	powerup_images.push_back(temp);
	temp = nullptr;

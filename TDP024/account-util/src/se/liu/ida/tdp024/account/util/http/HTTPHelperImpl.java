...
public class HTTPHelperImpl implements HTTPHelper {
    ...
    //final private Logger accountLogger = new LoggerImpl();
    ...
    public String get(String endpoint, String... parameters) {
        ...
        try {
            ...
            //accountLogger.log(LoggerLevel.ERROR, "HTTPHelperImpl::get(" + endpoint + ") => ERROR FOUND: " + e.getMessage());
        }
        return result;
    ...
    private String createURL(String endpoint, String... parameters) {
        ...
        for (int i = 0; i < (parameters.length - 1); i += 2) {
            ...
            //accountLogger.log(LoggerLevel.ERROR, "HTTPHelperImpl::createURL(" + endpoint + ") => ERROR FOUND: " + e.getMessage());
            }
